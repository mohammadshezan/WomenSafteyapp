...
import 'bottomlist_model.dart';
export 'bottomlist_model.dart';
...
class _BottomlistWidgetState extends State<BottomlistWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BottomlistModel());
